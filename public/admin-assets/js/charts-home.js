$(document).ready(function () {
    ...
    const chartTargets = $('#lineCahrt, #barChartExample1, #lineChart1, #barChartExample2, #pieChartHome1, #pieChartHome2, #pieChartHome3, #salesBarChart1, #salesBarChart2, #visitPieChart');
