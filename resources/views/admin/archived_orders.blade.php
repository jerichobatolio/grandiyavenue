            ...
            <div class="container-fluid">
                ...
                <div class="page-header-content">
                    <h1 class="page-title">
                        ...
                        <a href="/orders" style="margin-left: auto; background: rgba(255,255,255,0.2); padding: 8px 16px; border-radius: 6px; text-decoration: none; color: white; font-size: 14px; font-weight: normal;">
                            View Active Orders
                        </a>
                    </h1>
                    ...
                    @if(!$orders->isEmpty())
                        <div class="stats-container">
                            ...
                            <div class="stat-box">
                                <div class="stat-number">{{ $orders->where('delivery_status', 'Delivered')->count() }}</div>
                                <div class="stat-label">Delivered</div>
                            </div>
                            <div class="stat-box">
                                <div class="stat-number">{{ $orders->where('delivery_status', 'Cancelled')->count() }}</div>
                                <div class="stat-label">Cancelled</div>
                            </div>
                            <div class="stat-box">
                                <div class="stat-number">PHP {{ number_format($orders->sum(function($order) { return (float)$order->price * (int)$order->quantity; }), 2) }}</div>
                ...
                @if($orders->isEmpty())
                    <div style="text-align: center; padding: 60px 20px; background: white; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        <i class="fas fa-archive empty-state-icon" style="font-size: 64px; color: #cbd5e0; margin-bottom: 20px;"></i>
                        <h3 style="color: #6b7280; font-size: 24px; margin-bottom: 10px;">No Archived Orders</h3>
                        <p style="color: #9ca3af; font-size: 16px;">Archived orders will appear here when you archive them from the active orders page.</p>
                    </div>
                @else
